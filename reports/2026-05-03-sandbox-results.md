# Sandbox Execution Results — Runtime Behavior

> Date: 2026-05-03 | Audited by [ClawSec](https://clawsec.cc) (Firecracker microVM)

## Network Activity (0 skills made outbound connections)

| Skill | Verdict | Risk | Connections | Targets |
|-------|---------|------|-------------|---------|

## File System Writes (0 skills wrote files)

| Skill | Verdict | Risk | Files Written |
|-------|---------|------|---------------|

## Startup Failures (1855 skills crashed)

| Skill | Verdict | Exit Code |
|-------|---------|-----------|
| [doubao-image](https://clawsec.cc/skill/doubao-image) | SUSPICIOUS | 1 |
...
| [component-api-design](https://clawsec.cc/skill/component-api-design) | SAFE | 1 |
