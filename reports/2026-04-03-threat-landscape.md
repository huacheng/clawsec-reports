...
Analysis of **20792** threats detected across **2103** audited skills.
...
|--------|-------|----------|
| LLM Semantic Detection | 15186 | LOW |
| Dynamic Code Evaluation | 2016 | HIGH |
| Startup Failure (non-executable) | 1945 | LOW |
| Outbound Data Transfer | 764 | HIGH |
