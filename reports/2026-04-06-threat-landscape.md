...
Analysis of **20802** threats detected across **2104** audited skills.
...
|--------|-------|----------|
| LLM Semantic Detection | 15194 | LOW |
| Dynamic Code Evaluation | 2017 | HIGH |
| Startup Failure (non-executable) | 1946 | LOW |
